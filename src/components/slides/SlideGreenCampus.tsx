  ...
  return (
    <SlideLayout>
      <div className="relative w-full h-full flex flex-col bg-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full px-14 pt-6 pb-4">
          {/* Centered header */}
          ...
          <div className="grid grid-cols-[280px_1fr] gap-6 flex-1 min-h-0 items-center">
            {/* Left: 3D image */}
            <div className="flex flex-col items-center justify-center h-full">
              <div className="w-[280px] h-[280px] rounded-2xl overflow-hidden border border-border/30 bg-white shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                {capabilityCards.map((card) => (
                  <div key={card.title} className="rounded-xl border border-border/40 bg-white p-3 shadow-sm">
                    <div className="flex items-center gap-2 mb-1">
                      <card.icon className="w-4 h-4 text-primary" />
                      <span className="text-[13px] font-bold text-foreground">{card.title}</span>
                    </div>
                    <div className={`text-[10px] font-semibold ${card.layerColor} mb-1.5`}>{card.layer}</div>
          ...
          {/* Bottom problem bar */}
          <div className="w-full mt-3 shrink-0 rounded-xl bg-primary/5 border border-primary/20 px-6 py-3 flex items-center gap-6">
