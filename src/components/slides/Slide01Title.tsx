  ...
  <SlideLayout>
    <div className="flex items-center justify-between h-full px-20">
      ...
      <div className="flex flex-col items-start max-w-[55%]">
        ...
        {/* Headline */}
        <h1 className="text-6xl font-extrabold text-foreground leading-tight mb-8 animate-fade-in text-left" style={{ animationDelay: "0.2s" }}>
        ...
        {/* Tagline */}
        <p className="text-2xl text-muted-foreground max-w-3xl mb-16 animate-fade-in text-left" style={{ animationDelay: "0.4s" }}>
      ...
      {/* Right 3D image */}
      <div className="flex items-center justify-center max-w-[42%] animate-fade-in" style={{ animationDelay: "0.4s" }}>
        <img
          src={hero3d}
