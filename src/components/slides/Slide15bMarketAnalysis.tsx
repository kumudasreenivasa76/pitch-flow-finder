...
const drivers = [
  {
    ...
    stats: [
      ...
      { label: "UAE DC electricity demand growth", value: "25–35% CAGR" },
      { label: "Typical optimization savings", value: "12–30%" },
    ],
    implication: "Clear, ROI-driven buyer urgency across UAE.",
  },
  {
    icon: "🌱",
    ...
    stats: [
      { label: "Carbon accounting CAGR (UAE)", value: "30–40%" },
      { label: "UAE I-REC market", value: "$500M+ /yr" },
      { label: "UAE Climate Law 2024", value: "Mandatory" },
      { label: "Net-zero commitments (UAE 2050)", value: "Accelerating" },
    ],
    implication: "Carbon spend becoming non-optional & recurring in UAE.",
  },
  {
    icon: "🏫",
    ...
    stats: [
      { label: "Priority education sites (UAE)", value: "12,000+" },
    ...
    implication: "Fast, credible entry wedge for platform adoption in UAE.",
  },
  {
    icon: "🖥️",
    ...
    stats: [
      { label: "Data centers in UAE", value: "~1,500" },
      { label: "Hyperscale growth CAGR (UAE)", value: "25–30%" },
      { label: "Grid constraint hubs (Dubai)", value: "Emerging" },
        ...
        <div className="flex items-start justify-between mb-6 animate-fade-in">
          <div>
            ...
            <h2 className="text-[40px] font-extrabold text-foreground leading-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              Energy, Carbon & Compliance <span className="text-primary">Converging in UAE</span>
            </h2>
            <p className="text-[15px] text-muted-foreground mt-1">Organizations across UAE face rising costs, stricter disclosure, and fragmented tooling.</p>
          </div>
          ...
          <div className="flex-shrink-0 ml-8 rounded-2xl border-2 border-rose-200 bg-rose-50/80 px-5 py-4 min-w-[230px]">
            ...
            <div className="mt-3 pt-2 border-t border-rose-200 text-[11px] font-bold text-rose-600 uppercase tracking-wide">
              No unified platforms exist in UAE
            </div>
          </div>
        </div>
