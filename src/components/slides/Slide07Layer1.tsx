...
const hotspots = [
  { id: 0, layer: "L1", icon: MapPin, label: "TerraScan™", top: "18%", left: "2%", role: "Site Feasibility", details: ["Rooftop / land identification", "MW potential estimation", "Structural readiness check", "Grid proximity analysis"], output: "Feasibility Report + Capacity Estimate" },
  { id: 1, layer: "L1", icon: Sun, label: "HelioTwin™", top: "18%", left: "20%", role: "3D Solar Modeling", details: ["3D digital twin creation", "Irradiance simulation", "Shading analysis", "Annual generation forecast"], output: "Projected kWh/year + Performance Ratio" },
  { id: 2, layer: "L1", icon: Activity, label: "CarbonX-Ray™", top: "18%", left: "40%", role: "Baseline Carbon Audit", details: ["Scope 1 & 2 emissions mapping", "Current energy intensity", "Carbon heatmap generation", "ESG readiness score"], output: "Carbon Baseline Report" },
  { id: 3, layer: "L1", icon: DollarSign, label: "CapStruct™", top: "18%", left: "60%", role: "Financial Structuring", details: ["CAPEX vs OPEX comparison", "IRR / NPV modeling", "LCOE calculation", "Ownership model (Direct / SPV / PPA)"], output: "Financial Feasibility & Investment Plan" },
  { id: 4, layer: "L1", icon: Zap, label: "SolarForge™", top: "45%", left: "2%", role: "Project Execution", details: ["EPC vendor selection", "SLA definition", "Installation tracking", "Commissioning verification"], output: "Live Solar Asset" },
  { id: 5, layer: "L1", icon: Activity, label: "GridLink™", top: "45%", left: "20%", role: "Utility Integration", details: ["Net metering setup", "Grid synchronization", "Renewable matching % tracking", "PPA alignment"], output: "Operational Renewable Flow" },
  { id: 6, layer: "L1", icon: ShoppingBag, label: "EcoMarket™", top: "45%", left: "40%", role: "Vendor Management", details: ["O&M tracking", "SLA compliance monitoring", "Warranty tracking", "Vendor performance scorecards"], output: "Operational Stability" },
  { id: 7, layer: "L2", icon: BarChart3, label: "VoltIQ™", top: "45%", left: "60%", role: "Real-Time Energy Dashboard", details: ["Live generation tracking", "Consumption vs production", "Renewable mix %", "Cost savings visualization"], output: "Energy Performance Dashboard" },
  { id: 8, layer: "L2", icon: Brain, label: "WattWise AI™", top: "72%", left: "2%", role: "Optimization Engine", details: ["Load forecasting", "Solar degradation alerts", "Peak shaving recommendations", "Battery optimization"], output: "Improved Efficiency + Lower Bills" },
  { id: 9, layer: "L3", icon: Award, label: "RECMatrix™", top: "72%", left: "20%", role: "REC Management", details: ["REC generation tracking", "Registry integration", "REC inventory dashboard", "Market value estimation"], output: "REC Revenue Opportunity" },
  { id: 10, layer: "L3", icon: PieChart, label: "CarbonLedger™", top: "72%", left: "40%", role: "Carbon Accounting", details: ["Carbon avoided calculation", "Offset valuation", "Multi-site aggregation", "Carbon asset visibility"], output: "Carbon Asset Report" },
  { id: 11, layer: "L3", icon: Target, label: "NetZero Navigator™", top: "72%", left: "60%", role: "Target Tracking", details: ["Renewable % progress", "Carbon reduction trajectory", "Gap-to-target visualization"], output: "Net-Zero Progress Dashboard" },
];
